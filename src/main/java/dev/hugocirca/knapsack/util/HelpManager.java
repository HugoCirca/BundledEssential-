...
public class HelpManager implements CommandExecutor {
    ...
    private ItemStack buildBook() {
        ...
        pages.add("§4§lEconomy\n§1/pay <p> <amt>\n§0- send money (5% tax)\n§1/bounty <p> [amt]\n§0- put a price on heads\n§1/paytax\n§0- clear your tax debt → Bank\n§1/serverbank\n§0- see Bank overflow at cap\n§1/loan\n§0- borrow $200-2500 GUI");
        pages.add("§4§lLoan\n§1/loan\n§0- bedrock 200,500,1000,1500,2000,2500\n§1+ compass custom\n§0- anvil for custom 50-10000\n§1Pick repay:\n§03/7/14/30d lump or slow 20%\n§1/loan pay [id|all]\n§0- repay early +$25 bonus\n§1/loan info\n§0- list debts");
    ...
    private void sendChat(CommandSender sender) {
        sender.sendMessage("§6§l=== KnapsackPlugin Commands ===");
        sender.sendMessage("");
        ...
        sender.sendMessage("  §7/resetbal <p> [amt] §f- Admin: reset/set balance (cap from config)");
        sender.sendMessage("  §7/serverbank §f- Show Bank (tax+overflow)");
        sender.sendMessage("  §7/loan §f- Borrow GUI (bedrock 200-2500, compass custom)");
        sender.sendMessage("  §7/loan pay [id|all] §f- Repay (+$25 bonus if on time)");
        sender.sendMessage("  §7/loan info §f- List active loans");
        sender.sendMessage("  §7/pay <player> <amount> §f- Pay a player");
        sender.sendMessage("  §7/bounty <player> [amount] §f- Set/check bounty");
        sender.sendMessage("  §7/paytax §f- Pay accumulated taxes → Bank");

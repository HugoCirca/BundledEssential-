...
public class PriceManager implements Saveable {
    ...
    private void loadShopPrices() {
        JsonObject data = JsonStorage.load(plugin, "shop.json");
    ...
    public void saveShopPrices() {
        ...
        JsonStorage.save(plugin, "shop.json", data);
    }

    @Override
    public void saveAll() { saveShopPrices(); }
    ...
    private void initPrices() {
        ...
        set("END_ROD", 15.00);
        set("DRAGON_EGG", 5000.00); set("END_CRYSTAL", 100.00);
        ...
        // === AUTO-GENERATED FROM items.txt 1537 items (360 missing) - rarity-based ===
        // Chunk1 122 items (ACACIA_DOOR -> EXPOSED_LIGHTNING_ROD)
        set("ACACIA_DOOR", 1.50);
        set("ACACIA_FENCE", 0.85);
        set("ACACIA_FENCE_GATE", 1.00);
        set("ACACIA_HANGING_SIGN", 2.00);
        set("ACACIA_PRESSURE_PLATE", 1.00);
        set("ACACIA_SLAB", 0.50);
        set("ACACIA_STAIRS", 1.00);
        set("ACACIA_TRAPDOOR", 1.25);
        set("AMETHYST_CLUSTER", 4.00);
        set("ANGLER_POTTERY_SHERD", 8.00);
        set("ARCHER_POTTERY_SHERD", 8.00);
        set("ARMS_UP_POTTERY_SHERD", 8.00);
        set("BAMBOO_DOOR", 1.50);
        set("BAMBOO_FENCE", 0.85);
        set("BAMBOO_FENCE_GATE", 1.00);
        set("BAMBOO_MOSAIC_SLAB", 0.50);
        set("BAMBOO_MOSAIC_STAIRS", 1.00);
        set("BAMBOO_PRESSURE_PLATE", 1.00);
        set("BAMBOO_SLAB", 0.30);
        set("BAMBOO_STAIRS", 0.75);
        set("BAMBOO_TRAPDOOR", 1.25);
        set("BEEHIVE", 8.00);
        set("BEE_NEST", 12.00);
        set("BLACK_CARPET", 0.60);
        set("BLACK_DYE", 0.75);
        set("BLACK_GLAZED_TERRACOTTA", 1.50);
        set("BLADE_POTTERY_SHERD", 8.00);
        set("BLUE_CARPET", 0.60);
        set("BLUE_DYE", 1.00);
        set("BLUE_EGG", 0.50);
        set("BLUE_GLAZED_TERRACOTTA", 1.50);
        set("BLUE_ICE", 4.00);
        set("BOOK", 2.50);
        set("BORDURE_INDENTED_BANNER_PATTERN", 8.00);
        set("BOWL", 0.50);
        set("BRAIN_CORAL", 2.50);
        set("BRAIN_CORAL_BLOCK", 4.00);
        set("BRAIN_CORAL_FAN", 2.00);
        set("BREWER_POTTERY_SHERD", 8.00);
        set("BRICK", 0.75);
        set("BROWN_CARPET", 0.60);
        set("BROWN_DYE", 0.75);
        set("BROWN_EGG", 0.50);
        set("BROWN_GLAZED_TERRACOTTA", 1.50);
        set("BUBBLE_CORAL", 2.50);
        set("BUBBLE_CORAL_BLOCK", 4.00);
        set("BUBBLE_CORAL_FAN", 2.00);
        set("BURN_POTTERY_SHERD", 8.00);
        set("CHERRY_DOOR", 1.50);
        set("CHERRY_FENCE", 0.85);
        set("CHERRY_FENCE_GATE", 1.00);
        set("CHERRY_PRESSURE_PLATE", 1.00);
        set("CHERRY_SLAB", 0.50);
        set("CHERRY_STAIRS", 1.00);
        set("CHERRY_TRAPDOOR", 1.25);
        set("CLAY_BALL", 0.40);
        set("CLOSED_EYEBLOSSOM", 2.50);
        set("COBWEB", 3.00);
        set("COPPER_AXE", 8.00);
        set("COPPER_BARS", 3.00);
        set("COPPER_BOOTS", 7.00);
        set("COPPER_CHAIN", 3.50);
        set("COPPER_CHESTPLATE", 12.00);
        set("COPPER_HELMET", 8.00);
        set("COPPER_HOE", 5.00);
        set("COPPER_HORSE_ARMOR", 12.00);
        set("COPPER_LANTERN", 2.50);
        set("COPPER_LEGGINGS", 10.00);
        set("COPPER_NAUTILUS_ARMOR", 15.00);
        set("COPPER_NUGGET", 0.35);
        set("COPPER_PICKAXE", 8.00);
        set("COPPER_SHOVEL", 4.00);
        set("COPPER_SPEAR", 8.00);
        set("COPPER_SWORD", 8.00);
        set("COPPER_TORCH", 0.50);
        set("CREEPER_BANNER_PATTERN", 8.00);
        set("CRIMSON_FENCE_GATE", 1.25);
        set("CRIMSON_HANGING_SIGN", 2.50);
        set("CRIMSON_PRESSURE_PLATE", 1.25);
        set("CRIMSON_SLAB", 0.60);
        set("CRIMSON_STAIRS", 1.25);
        set("CUT_RED_SANDSTONE_SLAB", 0.50);
        set("CUT_SANDSTONE_SLAB", 0.50);
        set("CYAN_CARPET", 0.60);
        set("CYAN_DYE", 0.75);
        set("CYAN_GLAZED_TERRACOTTA", 1.50);
        set("DANGER_POTTERY_SHERD", 8.00);
        set("DARK_OAK_DOOR", 1.50);
        set("DARK_OAK_FENCE", 0.85);
        set("DARK_OAK_FENCE_GATE", 1.00);
        set("DARK_OAK_HANGING_SIGN", 2.00);
        set("DARK_OAK_PRESSURE_PLATE", 1.00);
        set("DARK_OAK_SLAB", 0.50);
        set("DARK_OAK_STAIRS", 1.00);
        set("DARK_OAK_TRAPDOOR", 1.25);
        set("DARK_PRISMARINE_SLAB", 4.00);
        set("DARK_PRISMARINE_STAIRS", 8.00);
        set("DEAD_BRAIN_CORAL", 1.00);
        set("DEAD_BRAIN_CORAL_BLOCK", 1.50);
        set("DEAD_BRAIN_CORAL_FAN", 0.75);
        set("DEAD_BUBBLE_CORAL", 1.00);
        set("DEAD_BUBBLE_CORAL_BLOCK", 1.50);
        set("DEAD_BUBBLE_CORAL_FAN", 0.75);
        set("DEAD_BUSH", 0.30);
        set("DEAD_FIRE_CORAL", 1.00);
        set("DEAD_FIRE_CORAL_BLOCK", 1.50);
        set("DEAD_FIRE_CORAL_FAN", 0.75);
        set("DEAD_HORN_CORAL", 1.00);
        set("DEAD_HORN_CORAL_BLOCK", 1.50);
        set("DEAD_HORN_CORAL_FAN", 0.75);
        set("DEAD_TUBE_CORAL", 1.00);
        set("DEAD_TUBE_CORAL_BLOCK", 1.50);
        set("DEAD_TUBE_CORAL_FAN", 0.75);
        set("DIAMOND_NAUTILUS_ARMOR", 40.00);
        set("DIAMOND_SPEAR", 200.00);
        set("ENCHANTED_BOOK", 15.00);
        set("EXPERIENCE_BOTTLE", 12.00);
        set("EXPLORER_POTTERY_SHERD", 10.00);
        set("EXPOSED_COPPER_BARS", 3.00);
        set("EXPOSED_COPPER_CHAIN", 3.50);
        set("EXPOSED_COPPER_LANTERN", 2.50);
        set("EXPOSED_CUT_COPPER", 3.25);
        set("EXPOSED_CUT_COPPER_SLAB", 1.75);
        set("EXPOSED_CUT_COPPER_STAIRS", 3.50);
        set("EXPOSED_LIGHTNING_ROD", 5.00);
        set("FIELD_MASONED_BANNER_PATTERN", 12.00);
        set("FILLED_MAP", 4.00);
        set("FIREWORK_ROCKET", 1.50);
        set("FIREWORK_STAR", 1.00);
        set("FIRE_CHARGE", 1.00);
        set("FIRE_CORAL", 1.25);
        set("FIRE_CORAL_BLOCK", 1.50);
        set("FIRE_CORAL_FAN", 1.25);
        set("FLOWER_BANNER_PATTERN", 12.00);
        set("FLOW_BANNER_PATTERN", 15.00);
        set("FLOW_POTTERY_SHERD", 8.00);
        set("FRIEND_POTTERY_SHERD", 8.00);
        set("FURNACE_MINECART", 10.00);
        set("GLASS_BOTTLE", 0.50);
        set("GLOBE_BANNER_PATTERN", 25.00);
        set("GOAT_HORN", 25.00);
        set("GOLDEN_NAUTILUS_ARMOR", 45.00);
        set("GOLDEN_SPEAR", 12.00);
        set("GRAY_CARPET", 0.60);
        set("GRAY_DYE", 1.00);
        set("GRAY_GLAZED_TERRACOTTA", 1.75);
        set("GREEN_CARPET", 0.60);
        set("GREEN_DYE", 1.25);
        set("GREEN_GLAZED_TERRACOTTA", 1.75);
        set("GUSTER_BANNER_PATTERN", 18.00);
        set("GUSTER_POTTERY_SHERD", 8.00);
        set("HEARTBREAK_POTTERY_SHERD", 8.00);
        set("HEART_POTTERY_SHERD", 8.00);
        set("HORN_CORAL", 1.25);
        set("HORN_CORAL_BLOCK", 1.50);
        set("HORN_CORAL_FAN", 1.25);
        set("HOST_ARMOR_TRIM_SMITHING_TEMPLATE", 25.00);
        set("HOWL_POTTERY_SHERD", 8.00);
        set("ICE", 1.00);
        set("INFESTED_CHISELED_STONE_BRICKS", 1.00);
        set("INFESTED_CRACKED_STONE_BRICKS", 0.85);
        set("INFESTED_DEEPSLATE", 1.25);
        set("INFESTED_MOSSY_STONE_BRICKS", 1.00);
        set("INFESTED_STONE_BRICKS", 0.85);
        set("IRON_CHAIN", 3.50);
        set("IRON_DOOR", 5.00);
        set("IRON_NAUTILUS_ARMOR", 30.00);
        set("IRON_SPEAR", 15.00);
        set("IRON_TRAPDOOR", 4.50);
        set("JUNGLE_DOOR", 1.50);
        set("JUNGLE_FENCE", 0.85);
        set("JUNGLE_FENCE_GATE", 1.00);
        set("JUNGLE_HANGING_SIGN", 2.00);
        set("JUNGLE_PRESSURE_PLATE", 1.00);
        set("JUNGLE_SLAB", 0.50);
        set("JUNGLE_STAIRS", 1.00);
        set("JUNGLE_TRAPDOOR", 1.25);
        set("LIGHT_BLUE_CARPET", 0.60);
        set("LIGHT_BLUE_DYE", 1.00);
        set("LIGHT_BLUE_GLAZED_TERRACOTTA", 1.75);
        set("LIGHT_GRAY_CARPET", 0.60);
        set("LIGHT_GRAY_DYE", 1.00);
        set("LIGHT_GRAY_GLAZED_TERRACOTTA", 1.75);
        set("LIME_CARPET", 0.60);
        set("LIME_DYE", 1.00);
        set("LIME_GLAZED_TERRACOTTA", 1.75);
        set("LINGERING_POTION", 8.00);
        set("MAGENTA_CARPET", 0.60);
        set("MAGENTA_DYE", 1.00);
        set("MAGENTA_GLAZED_TERRACOTTA", 1.75);
        set("MANGROVE_DOOR", 1.75);
        set("MANGROVE_FENCE", 0.85);
        set("MANGROVE_FENCE_GATE", 1.00);
        set("MANGROVE_HANGING_SIGN", 2.50);
        set("MANGROVE_PRESSURE_PLATE", 1.00);
        set("MANGROVE_SLAB", 0.50);
        set("MANGROVE_STAIRS", 1.00);
        set("MANGROVE_TRAPDOOR", 1.25);
        set("MINER_POTTERY_SHERD", 8.00);
        set("MOJANG_BANNER_PATTERN", 25.00);
        set("MOSSY_STONE_BRICK_SLAB", 0.85);
        set("MOSSY_STONE_BRICK_STAIRS", 1.75);
        set("MOSSY_STONE_BRICK_WALL", 1.00);
        set("MOURNER_POTTERY_SHERD", 8.00);
        set("MUSIC_DISC_LAVA_CHICKEN", 30.00);
        set("NETHERITE_HORSE_ARMOR", 120.00);
        set("NETHERITE_NAUTILUS_ARMOR", 150.00);
        set("NETHERITE_SPEAR", 800.00);
        set("NETHER_BRICK", 1.00);
        set("OCHRE_FROGLIGHT", 10.00);
        set("OMINOUS_BOTTLE", 20.00);
        set("OPEN_EYEBLOSSOM", 2.50);
        set("ORANGE_CARPET", 0.60);
        set("ORANGE_DYE", 1.00);
        set("ORANGE_GLAZED_TERRACOTTA", 1.75);
        set("OXIDIZED_COPPER_BARS", 3.00);
        set("OXIDIZED_COPPER_CHAIN", 3.50);
        set("OXIDIZED_COPPER_LANTERN", 2.50);
        set("OXIDIZED_CUT_COPPER", 3.25);
        set("OXIDIZED_CUT_COPPER_SLAB", 1.75);
        set("OXIDIZED_CUT_COPPER_STAIRS", 3.50);
        set("OXIDIZED_LIGHTNING_ROD", 5.00);
        set("PACKED_ICE", 2.00);
        set("PALE_OAK_DOOR", 1.75);
        set("PALE_OAK_FENCE", 0.85);
        set("PALE_OAK_FENCE_GATE", 1.00);
        set("PALE_OAK_PRESSURE_PLATE", 1.00);
        set("PALE_OAK_SLAB", 0.50);
        set("PALE_OAK_STAIRS", 1.00);
        set("PALE_OAK_TRAPDOOR", 1.25);
        set("PEARLESCENT_FROGLIGHT", 10.00);
        set("PIGLIN_BANNER_PATTERN", 15.00);
        set("PINK_CARPET", 0.60);
        set("PINK_DYE", 1.00);
        set("PINK_GLAZED_TERRACOTTA", 1.75);
        set("PLENTY_POTTERY_SHERD", 8.00);
        set("POLISHED_ANDESITE_SLAB", 0.60);
        set("POLISHED_ANDESITE_STAIRS", 1.25);
        set("POLISHED_BLACKSTONE_PRESSURE_PLATE", 1.00);
        set("POLISHED_DIORITE_SLAB", 0.75);
        set("POLISHED_DIORITE_STAIRS", 1.50);
        set("POLISHED_GRANITE_SLAB", 0.75);
        set("POLISHED_GRANITE_STAIRS", 1.50);
        set("POTION", 5.00);
        set("SPLASH_POTION", 6.00);
        set("TIPPED_ARROW", 1.25);
        set("SPYGLASS", 8.00);
        set("PRISMARINE_BRICK_SLAB", 3.50);
        set("PRISMARINE_BRICK_STAIRS", 7.00);
        set("PRISMARINE_SLAB", 3.00);
        set("PRISMARINE_STAIRS", 6.00);
        set("PRISMARINE_WALL", 3.50);
        set("PRIZE_POTTERY_SHERD", 6.00);
        set("SCRAPE_POTTERY_SHERD", 6.00);
        set("SHEAF_POTTERY_SHERD", 6.00);
        set("SHELTER_POTTERY_SHERD", 6.00);
        set("SKULL_POTTERY_SHERD", 6.00);
        set("SNORT_POTTERY_SHERD", 6.00);
        set("PURPLE_CARPET", 1.00);
        set("RED_CARPET", 1.00);
        set("WHITE_CARPET", 1.00);
        set("YELLOW_CARPET", 1.00);
        set("PURPLE_DYE", 0.75);
        set("RED_DYE", 0.75);
        set("WHITE_DYE", 0.75);
        set("YELLOW_DYE", 0.75);
        set("PURPLE_GLAZED_TERRACOTTA", 1.75);
        set("RED_GLAZED_TERRACOTTA", 1.75);
        set("WHITE_GLAZED_TERRACOTTA", 1.75);
        set("YELLOW_GLAZED_TERRACOTTA", 1.75);
        set("QUARTZ_SLAB", 2.00);
        set("QUARTZ_STAIRS", 4.00);
        set("RAISER_ARMOR_TRIM_SMITHING_TEMPLATE", 30.00);
        set("SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE", 30.00);
        set("SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE", 80.00);
        set("WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE", 25.00);
        set("RESIN_BRICK", 1.50);
        set("SEA_PICKLE", 1.25);
        set("SHROOMLIGHT", 3.50);
        set("SMALL_AMETHYST_BUD", 2.00);
        set("TURTLE_SCUTE", 4.50);
        set("VERDANT_FROGLIGHT", 3.50);
        set("TUBE_CORAL", 1.00);
        set("TUBE_CORAL_BLOCK", 2.50);
        set("TUBE_CORAL_FAN", 1.25);
        set("SKULL_BANNER_PATTERN", 8.00);
        set("SMOOTH_RED_SANDSTONE_SLAB", 0.50);
        set("SMOOTH_RED_SANDSTONE_STAIRS", 1.00);
        set("SMOOTH_SANDSTONE_SLAB", 0.50);
        set("SMOOTH_SANDSTONE_STAIRS", 1.00);
        set("SMOOTH_STONE_SLAB", 0.50);
        set("SNOW", 0.30);
        set("SNOWBALL", 0.20);
        set("SNOW_BLOCK", 0.75);
        set("STONE_BRICK_SLAB", 0.65);
        set("STONE_BRICK_STAIRS", 1.25);
        set("STONE_BRICK_WALL", 0.85);
        set("STONE_SPEAR", 4.00);
        set("WOODEN_SPEAR", 1.50);
        set("SUGAR", 0.50);
        set("TRIPWIRE_HOOK", 0.75);
        set("WRITABLE_BOOK", 2.00);
        set("WRITTEN_BOOK", 3.00);
        set("WARPED_FENCE_GATE", 1.50);
        set("WARPED_HANGING_SIGN", 2.50);
        set("WARPED_PRESSURE_PLATE", 1.00);
        set("WARPED_SLAB", 0.65);
        set("WARPED_STAIRS", 1.50);
        set("WEATHERED_COPPER", 3.00);
        set("WEATHERED_COPPER_BARS", 3.00);
        set("WEATHERED_COPPER_CHAIN", 3.50);
        set("WEATHERED_COPPER_LANTERN", 4.00);
        set("WEATHERED_CUT_COPPER", 3.25);
        set("WEATHERED_CUT_COPPER_SLAB", 1.75);
        set("WEATHERED_CUT_COPPER_STAIRS", 3.50);
        set("WEATHERED_LIGHTNING_ROD", 5.00);
        set("WAXED_CHISELED_COPPER", 4.00);
        set("WAXED_COPPER_BARS", 3.50);
        set("WAXED_COPPER_CHAIN", 4.00);
        set("WAXED_COPPER_GOLEM_STATUE", 10.50);
        set("WAXED_COPPER_LANTERN", 4.50);
        set("WAXED_CUT_COPPER", 3.75);
        set("WAXED_CUT_COPPER_SLAB", 2.00);
        set("WAXED_CUT_COPPER_STAIRS", 4.00);
        set("WAXED_EXPOSED_CHISELED_COPPER", 4.00);
        set("WAXED_EXPOSED_COPPER", 3.50);
        set("WAXED_EXPOSED_COPPER_BARS", 3.50);
        set("WAXED_EXPOSED_COPPER_CHAIN", 4.00);
        set("WAXED_EXPOSED_COPPER_GOLEM_STATUE", 10.50);
        set("WAXED_EXPOSED_COPPER_GRATE", 4.50);
        set("WAXED_EXPOSED_COPPER_LANTERN", 4.50);
        set("WAXED_EXPOSED_COPPER_TRAPDOOR", 4.50);
        set("WAXED_EXPOSED_CUT_COPPER", 3.75);
        set("WAXED_EXPOSED_CUT_COPPER_SLAB", 2.00);
        set("WAXED_EXPOSED_CUT_COPPER_STAIRS", 4.00);
        set("WAXED_EXPOSED_LIGHTNING_ROD", 5.50);
        set("WAXED_LIGHTNING_ROD", 5.50);
        set("WAXED_OXIDIZED_CHISELED_COPPER", 4.00);
        set("WAXED_OXIDIZED_COPPER", 3.50);
        set("WAXED_OXIDIZED_COPPER_BARS", 3.50);
        set("WAXED_OXIDIZED_COPPER_CHAIN", 4.00);
        set("WAXED_OXIDIZED_COPPER_GOLEM_STATUE", 10.50);
        set("WAXED_OXIDIZED_COPPER_GRATE", 4.50);
        set("WAXED_OXIDIZED_COPPER_LANTERN", 4.50);
        set("WAXED_OXIDIZED_COPPER_TRAPDOOR", 4.50);
        set("WAXED_OXIDIZED_CUT_COPPER", 3.75);
        set("WAXED_OXIDIZED_CUT_COPPER_SLAB", 2.00);
        set("WAXED_OXIDIZED_CUT_COPPER_STAIRS", 4.00);
        set("WAXED_OXIDIZED_LIGHTNING_ROD", 5.50);
        set("WAXED_WEATHERED_CHISELED_COPPER", 4.00);
        set("WAXED_WEATHERED_COPPER", 3.50);
        set("WAXED_WEATHERED_COPPER_BARS", 3.50);
        set("WAXED_WEATHERED_COPPER_CHAIN", 4.00);
        set("WAXED_WEATHERED_COPPER_GOLEM_STATUE", 10.50);
        set("WAXED_WEATHERED_COPPER_GRATE", 4.50);
        set("WAXED_WEATHERED_COPPER_LANTERN", 4.50);
        set("WAXED_WEATHERED_COPPER_TRAPDOOR", 4.50);
        set("WAXED_WEATHERED_CUT_COPPER", 3.75);
        set("WAXED_WEATHERED_CUT_COPPER_SLAB", 2.00);
        set("WAXED_WEATHERED_CUT_COPPER_STAIRS", 4.00);
        set("WAXED_WEATHERED_LIGHTNING_ROD", 5.50);
